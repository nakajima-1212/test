...
import com.symphony.xwork2.ActionSupport;


public class MyPageAction extend ActionSupport implements SessionAware{
  ...
  public String execute() throws SQLException{
    ...
    //商品経歴を削除しない場合
    if(deleteFlg == null){
      String item_transaction_id = session.ger("id").toString();
      ...
      delete();
             ...
             public void dalete() throws SQLException{
